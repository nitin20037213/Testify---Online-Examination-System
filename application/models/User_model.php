...
Class User_model extends CI_Model
{
 function login($username, $password)
 {
   ...
   if (strpos($username, '@') !== true) {
    $this->db->where('savsoft_users.uid', $username);
   }else{
...
return $revenue;
 ...
 function user_list($limit){
	 if($this->input->post('search')){
		 ...
		 $this->db->or_like('savsoft_users.full_name',$search);
		 $this->db->or_where('savsoft_users.father_name',$search);
          $this->db->or_where('savsoft_users.district',$search);
           $this->db->or_where('savsoft_users.village_city',$search);
...
$verilink=$veri_code;
 ...
 if($this->config->item('protocol')=="smtp"){
            ...
            $subject=str_replace('[verilink]',$verilink,$subject);
			$message=str_replace('[verilink]',$verilink,$message);
            $message=str_replace('[full_name]',$userdata['full_name'],$message);
            $message=str_replace('[uid]',$userdata['uid'],$message);
