...
?>
                              ...
                              <a href="#" data-toggle="collapse"
                                  data-target="#advance_options"><?php echo $this->lang->line('advance_options');?></a>
...
?>
                              ...
                              <div id="advance_options" class="collapse">
                                  ...
                                  <div class="form-group">
                                      <label
                                          for="inputEmail"><?php echo $this->lang->line('maximum_attempts');?></label>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="correct_score"
                                          value="<?php echo $quiz['correct_score'];?>" class="form-control"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="radio" name="show_chart_rank" value="1"
                                          <?php if($quiz['show_chart_rank']==1){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('yes');?>&nbsp;&nbsp;&nbsp;
                                      <input type="radio" name="show_chart_rank" value="0"
                                          <?php if($quiz['show_chart_rank']==0){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('no');?>
                                  </div>
				...
				?>
                                  <div class="form-group">
                                      ...
                                      <input type="radio" name="camera_req" value="1"
                                          <?php if($quiz['camera_req']==1){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('yes');?>&nbsp;&nbsp;&nbsp;
                                      <input type="radio" name="camera_req" value="0"
                                          <?php if($quiz['camera_req']==0){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('no');?>
                                  </div>
			...
			?>
					...
					foreach($group_list as $key => $val){
						?>
                                      ...
                                      <input type="checkbox" name="gids[]" value="<?php echo $val['gid'];?>"
                                          <?php if(in_array($val['gid'],explode(',',$quiz['gids']))){ echo 'checked'; } ?>>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select class="js-example-basic-multiple form-control" name="uids[]"
                                          ...
                                          <option value="<?php echo $uval['uid'];?>"
                                              <?php if(in_array($uval['uid'],explode(',',$quiz['uids']))){ echo 'selected'; } ?>>
                                              <?php echo $uval['first_name'].' '.$uval['last_name'].' ('.$uval['email'].')';?>
                                          </option>
                                          <?php } ?>
                                      </select>
					...
					?>
                                          <option value="<?php echo $val;?>"
                                              <?php if($quiz['quiz_template']==$val){ echo 'selected';} ?>>
                                              <?php echo $val;?></option>
                                          <?php 
					}
					?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="quiz_price" value="<?php echo $quiz['quiz_price'];?>"
                                          class="form-control"
                                          placeholder="<?php echo $this->lang->line('quiz_price');?>" required>
                                  ...
                                  <div class="form-group">
                                      <label
                                          for="inputEmail"><?php echo $this->lang->line('generate_certificate');?></label>
                                      <br>
                                      <input type="radio" name="gen_certificate" value="1"
                                          <?php if($quiz['gen_certificate']==1){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('yes');?><br>
                                      <input type="radio" name="gen_certificate" value="0"
                                          <?php if($quiz['gen_certificate']==0){ echo 'checked'; } ?>>
                                      <?php echo $this->lang->line('no');?>
                                  </div>

                                  <div class="form-group">
                                      <label
                                          for="inputEmail"><?php echo $this->lang->line('certificate_text');?></label>
                                      ...
                                      <span
                                          style="color:#ff0000"><?php echo $this->lang->line('preview_warning');?></span>
                                  </div>
...
if(!$this->session->flashdata('addquestion')){
?>
                              <div class='alert alert-warning'><?php echo $this->lang->line('no_question_warning');?>
                              </div>
                              <?php 
 }
 ?>
...
?>
                                  <tr>
                                      ...
                                      <td><input type="text" style="width:60px;" name="i_correct[]"
                                              value="<?php if(isset($quiz['correct_score'][$key])){ echo explode(',',$quiz['correct_score'])[$key]; }else{ echo '1'; } ?>">
                                      </td>
                                      <td><input type="text" style="width:60px;" name="i_incorrect[]"
                                              value="<?php if(isset($quiz['incorrect_score'][$key])){ echo explode(',',$quiz['incorrect_score'])[$key]; }else{ echo '0'; } ?>">
                                      </td>
                                      <td>
 ...
 if($key==0){
	 ...
	 ?>
                                          <a
                                              href="javascript:cancelmove('Up','<?php echo $quiz['quid'];?>','<?php echo $val['qid'];?>','<?php echo $key+1;?>');"><img
...
?>
	...
	?>
                                          <a
                                              href="javascript:cancelmove('Down','<?php echo $quiz['quid'];?>','<?php echo $val['qid'];?>','<?php echo $key+1;?>');"><img
	...
	foreach($qcl as $k => $vall){
		...
		?>
                              ...
                              <div class="form-group">
                                  <select name="cid[]">
                                      <option value="0"><?php echo $this->lang->line('select');?>
                                          <?php echo $this->lang->line('category_name');?></option>
                                      <?php 
					foreach($category_list as $key => $val){
						?>

                                      <option value="<?php echo $val['cid'];?>"
                                          <?php if($val['cid']==$vall['cid']){ echo 'selected'; } ?>>
					...
					?>
                                  ...
                                  <select name="lid[]">
                                      <option value="0"><?php echo $this->lang->line('select');?>
                                          <?php echo $this->lang->line('level_name');?></option>
                                      <?php 
					foreach($level_list as $key => $val){
						?>

                                      <option value="<?php echo $val['lid'];?>"
                                          <?php if($val['lid']==$vall['lid']){ echo 'selected'; } ?>>
					...
					?>
                                  ...
                                  <?php echo $this->lang->line('correct');?> <input type="text" name="i_correct[]"
                                      style="width:40px;" value="<?php echo $vall['i_correct'];?>"> |
                                  <?php echo $this->lang->line('incorrect');?> <input type="text" style="width:40px;"
                                      name="i_incorrect[]" value="<?php echo $vall['i_incorrect'];?>">
	...
	?>
					...
					foreach($category_list as $key => $val){
						?>
                                      ...
                                      <option value="<?php echo $val['cid'];?>"><?php echo $val['category_name'];?>
                                      </option>
                                      <?php 
					}
					?>
					...
					foreach($level_list as $key => $val){
						?>
                                      ...
                                      <option value="<?php echo $val['lid'];?>"><?php echo $val['level_name'];?>
                                      </option>
                                      <?php 
					}
					?>
                                  ...
                                  <?php echo $this->lang->line('incorrect_score');?>
...
?>
                              ...
                              <?php }else{ ?>
                              <button class="btn btn-success" type="submit"><?php echo $this->lang->line('update');?>
                                  <?php echo $this->lang->line('quiz');?></button>
                              <?php 
	}
	?>
                              <br><br><br>
