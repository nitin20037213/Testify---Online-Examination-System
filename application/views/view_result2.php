         ...
         <div class="col-lg-12"
             ...
             <div class="col-lg-12" style="margin-top:20px;">
                 ...
                 <div class="col-lg-2" style="text-align:center;">
                     ...
                     <p style="color:#e39500;font-size:14px;"><?php echo date('Y-m-d H:i:s',$result['start_time']);?>
                     </p>
...
?>
                 ...
                 <table class="table table-bordered">
                     <thead>
                         <tr>
                             ...
                             <th style="background:#337ab7;color:#ffffff;"><?php echo $this->lang->line('time_spent');?>
                             </th>
                             <th style="background:#337ab7;color:#ffffff;"><?php echo $this->lang->line('correct');?>
                             </th>
                             <th style="background:#337ab7;color:#ffffff;"><?php echo $this->lang->line('incorrect');?>
                             </th>
                             <th style="background:#337ab7;color:#ffffff;">
					  ...
					  if(isset($cia_cat[1][$vk])){ $no_iC=$cia_cat[1][$vk]; $incorrect+=$cia_cat[1][$vk]; }else{ $no_iC=0;  }
						?>
                         <tr>
                             ...
                             <td><?php echo (($no_C*$result['correct_score'])+($no_iC*$result['incorrect_score']));?>
                             </td>
             ...
             <div class="col-lg-12 noprint" style="margin-top:50px;">
                 <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                     <?php echo $this->lang->line('rank').': '.$rank;?> </button>
  ...
  if($rank != $last_rank ){
  ?>
                     <div class="circle_l s_title" data-toggle="tooltip" title="Last Rank"><?php echo $last_rank;?>
                     </div>
                     <?php 
  }else{
  ?>
                     <div class="circle_l s_title" data-toggle="tooltip" title="Your Rank is Last">
                         <?php echo $last_rank;?></div>
  ...
  ?>
             ...
             <div class="col-lg-12 noprint" style="margin-top:50px;">
                 <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                     <?php echo $this->lang->line('score_obtained').': '.$result['score_obtained'];?> </button>
                 <div class="td_line" style="float:left;width:700px;height:70px;">
                     <div <?php if($rank=='1'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result" <?php } ?>><?php echo $toppers[0]['score_obtained'];?>
                     </div>
                     <div <?php if($rank=='2'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result" <?php } ?>><?php echo $toppers[1]['score_obtained'];?>
                     </div>
                     <div <?php if($rank=='3'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result" <?php } ?>><?php echo $toppers[2]['score_obtained'];?>
                     </div>
                     <?php 
  if($rank > 3 ){
  ?>
  ...
  ?>
                     <div class="circle_l s_title" data-toggle="tooltip" title="Lowest Score">
                         <?php echo $looser['score_obtained'];?></div>
                     <?php 
  }else{
  ?>
  ...
  ?>
             ...
             <div class="col-lg-12 noprint" style="margin-top:50px;margin-bottom:50px;">
                 <button class="btn btn-default" style="margin-right:20px;width:141px;	float:left;">
                     <?php echo $this->lang->line('time').': '.secintomin($result['total_time']).' Min.';?> </button>
                 <div class="td_line" style="float:left;width:700px;height:70px;">
                     <div <?php if($rank=='1'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result" <?php } ?> style="font-size:12px;padding-top:10px;">
                         <?php echo secintomin($toppers[0]['total_time']);?></div>
                     <div <?php if($rank=='2'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result" <?php } ?> style="font-size:12px;padding-top:10px;">
                         <?php echo secintomin($toppers[1]['total_time']);?></div>
                     <div <?php if($rank=='3'){?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result" <?php } ?> style="font-size:12px;padding-top:10px;">
                         <?php echo secintomin($toppers[2]['total_time']);?></div>
                     <?php 
  if($rank > 3 ){
  ?>
