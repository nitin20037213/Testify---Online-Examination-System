...
<div style="display:none;width:100%;height:90%;background:#212121;position:fixed;z-index:1700;top:0px;right:0px;padding-top:10%;opacity:0.7"
    id="advertisement_bg">
...
<div class="footer-container">
    Powered By <a href="<?php echo base_url();?>" class="footer-note" style="color:#4E73DF; 
text-decoration: none !important;
 font-family: 'Kavoon', cursive;
 letter-spacing:2px">
        Testify
    </a><br>© <?php $year = date ("Y"); echo $year ; ?> All rights reserved.
</div>
</div>
...
<div id="duplicate_question"
    style="display:none;position:fixed;z-index:1000;width:100%;bottom:0px;height:220px;overflow-y:auto;background:#212121;color:#ffffff;padding:8px;">
