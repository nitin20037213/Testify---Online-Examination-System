    ...
    <div class="card shadow p-4">
		...
		?>
                            <table class="table table-bordered tbl">
                                ...
                                <!--<tr><td><?php echo $this->lang->line('tm');?></td><td><?php echo $quiz['tm'];?></td></tr>
...
<tr><td><?php echo $this->lang->line('end_date');?></td><td><?php echo date('Y-m-d H:i:s',$quiz['end_date']);?></td></tr> -->
                                ...
                                <tr>
                                    <td><?php echo $this->lang->line('noq');?></td>
                                    <td><?php echo $quiz['noq'];?></td>
                                </tr>
                                <tr>
...
?>
                            ...
                            <br><br>
                            <script type="text/javascript" src="<?php echo base_url();?>js/webcamjs/webcam.js">
                            </script>
                            ...
                            <button class="btn btn-success" type="button" 
                               ><?php echo $this->lang->line('capture_start_quiz');?></button>

                            <?php 
}else{
?> <div class="row col-md-4 p-4 text-center" style="margin: auto;">
	...
	?>
                            ...
                            <button class="btn btn-success"
                                type="submit"  onClick="javascript:goFS();"><?php echo $this->lang->line('start_quiz');?></button>
                            &nbsp;&nbsp;&nbsp;&nbsp; <a
...
?>
                            <div class="alert alert-danger">
                                <?php echo str_replace('{base_url}',base_url(),$this->lang->line('login_required'));?>
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp; <a
                                href="<?php echo site_url('quiz/open_quiz/0');?>"><?php echo $this->lang->line('back');?></a>
                            <?php
