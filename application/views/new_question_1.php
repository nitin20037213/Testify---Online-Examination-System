             ...
             <div class="row shadow py-4">
                 <div class="col-lg-6">
                     <div class="form-group">
                         ...
                         <span style="color:red; font-size:12px;"><a href="javascript:toogleuperror();">Getting
                                 error while uploading image?</a> "The upload path does not appear to be
                             valid"</span>
         ...
         <div class="col-lg-6">
             <div class="form-group">
                 <label for="inputEmail"><?php echo $this->lang->line('options');?>
                     <?php echo $i;?>) <?php echo ' : '.$val;?></label> <br>
                 <?php 
if($lkey==0){
?> <input type="radio" name="score" value="<?php echo $i-1;?>" <?php if($i==1){ echo 'checked'; } ?>> Select Correct
                 Option
                 <?php }else{ ?> <?php } 
...
?>
     ...
     <button class="btn btn-primary mr-4" type="submit"><?php echo $this->lang->line('submit');?></button>
     <?php 
if($para==1){
